...
return [
    ...
    ['GET',    '/admin/departments',          'admin_groups@departments',   ['auth', 'rbac:admin.roles', 'module:admin_departments']],
    ['GET',    '/admin/access-groups',        'admin_groups@access_groups', ['auth', 'rbac:admin.roles', 'module:admin_access_groups']],
    ['GET',    '/api/admin/groups/{id}',      'admin_groups@group_json',    ['auth', 'rbac:admin.roles']],
    ...
    ['GET',    '/admin/reset',                'reset@index',                ['auth', 'rbac:system.reset', 'module:admin_reset']],
    ['GET',    '/admin/reset/history',        'reset@history',              ['auth', 'rbac:system.reset', 'module:admin_reset']],
    ['GET',    '/admin/reset/download',       'reset@download',             ['auth', 'rbac:system.reset']],
    ['POST',   '/admin/reset/understand',     'reset@step_understand',      ['auth', 'csrf', 'rbac:system.reset']],
    ['POST',   '/admin/reset/reason',         'reset@step_reason',          ['auth', 'csrf', 'rbac:system.reset']],
    ['POST',   '/admin/reset/authenticate',   'reset@step_authenticate',    ['auth', 'csrf', 'rbac:system.reset']],
    ['POST',   '/admin/reset/backup',         'reset@step_backup',          ['auth', 'csrf', 'rbac:system.reset']],
    ['POST',   '/admin/reset/backup-confirm', 'reset@step_backup_confirm',  ['auth', 'csrf', 'rbac:system.reset']],
    ['POST',   '/admin/reset/password',       'reset@step_password',        ['auth', 'csrf', 'rbac:system.reset']],
    ['POST',   '/admin/reset/execute',        'reset@execute',              ['auth', 'csrf', 'rbac:system.reset']],
    ['POST',   '/admin/reset/scoped',         'reset@scoped_execute',       ['auth', 'csrf', 'rbac:system.reset']],
    ...
    ['GET',    '/admin/device-audit',         'device_audit@index',         ['auth', 'rbac:device_audit.view', 'module:device_audit']],
    ['GET',    '/api/admin/device-audit/user/{id}', 'device_audit@user_history', ['auth', 'rbac:device_audit.view', 'module:device_audit']],
    ['GET',    '/api/admin/device-audit/events',    'device_audit@events_json',  ['auth', 'rbac:device_audit.view', 'module:device_audit']],
    ['POST',   '/admin/device-audit/label',   'device_audit@save_label',    ['auth', 'csrf', 'rbac:device_audit.view', 'module:device_audit']],
    ...
    ['GET',    '/admin/branding',             'branding@index',             ['auth', 'rbac:admin.settings', 'module:admin_settings']],
    ['POST',   '/admin/branding',             'branding@save',              ['auth', 'csrf', 'rbac:admin.settings']],
    ['POST',   '/admin/branding/reset',       'branding@reset_branding',    ['auth', 'csrf', 'rbac:admin.settings']],
